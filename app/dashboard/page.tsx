...
export default function Dashboard() {
  ...
  // STATE NOTIF (Cuma butuh status loading kirim aja)
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        // ------------------------------------------------------------------
        // 🔥 BAGIAN INI GW BENERIN BIAR GAK RESET MINTA IZIN MULU 🔥
        // ------------------------------------------------------------------
        if (typeof window !== "undefined") {
            ...
            if (w.OneSignal && w.OneSignal.initialized) {
                // Kalo udah jalan, Login user aja. Gak usah Init ulang.
                w.OneSignal.login(user.id);
            } else {
                // Kalo belum jalan, baru kita inisialisasi
                ...
                w.OneSignalDeferred.push(async function (OneSignal: any) {
                    ...
                    // Otomatis aktifkan notif (silent check)
  ...
  return (
    <div className="w-full text-zinc-900 dark:text-white font-sans p-4 md:p-8 relative bg-zinc-50 dark:bg-black transition-colors duration-300 min-h-screen">
        ...
        <div className="relative z-10 max-w-7xl mx-auto space-y-10 animate-in fade-in duration-700 pb-20">
            ...
            {/* 🔥 BAGIAN INI GW SIMPELIN BIAR GAK RIBET (LANGSUNG READY) 🔥 */}
                   ...
                   <div className="flex items-start gap-4">
                       ...
                       <div>
                           ...
                           <p className="text-zinc-500 dark:text-zinc-400 text-sm mt-1 max-w-lg">
                               Sistem notifikasi sudah standby. Klik tombol tes untuk memastikan HP kamu bunyi.
                           </p>
                       </div>
                   </div>

                   {/* LANGSUNG TAMPILIN TOMBOL TES AJA */}
            ...
            {/* SISA KODE KE BAWAH PERSIS SAMA KAYAK KODE ASLI LU */}
            {/* STATISTIK */}
