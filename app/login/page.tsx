...
export default function Login() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-black px-4 py-12 text-white selection:bg-yellow-500/30">
      ...
      {/* Tombol Balik - DITURUNIN KE TOP-24 BIAR GAK KETABRAK NAVBAR */}
      <div className="absolute left-4 top-24 sm:left-8 sm:top-24 z-10">
      ...
      <div className="w-full max-w-md space-y-8 mt-10">
        ...
        <div className="mt-8 space-y-6 rounded-2xl border border-white/10 bg-zinc-900/50 p-8 shadow-xl backdrop-blur-sm">
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="juragan@kopi-senja.com"
              />
            </div>
            <div>
          ...
          <div className="relative mt-4">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-zinc-900 px-2 text-zinc-500">Atau masuk dengan</span>
            </div>
          </div>

           <button className="flex w-full items-center justify-center gap-3 rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-sm font-medium text-white transition-colors hover:bg-white/10">
        ...
        <p className="text-center text-sm text-zinc-400">
          Belum punya akun?{' '}
          <Link href="/register" className="font-semibold text-yellow-500 hover:text-yellow-400">
            Daftar Gratis
          </Link>
        </p>
      </div>
